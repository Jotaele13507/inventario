...
<head>
  ...
  <title>
    ...
    else echo "Almacen VIP - El asistente virtual para tu negocio -- By Yoel."; ?>
  </title>
...
<body>
  <?php if ($session->isUserLoggedIn(true)) : ?>
    <header id="header">
      <div class="logo pull-left"> ALMACÉN VIP </div>
      <div class="header-content">
        <div class="header-date pull-left">
            <strong>La Fecha de hoy es:<?php echo date("d/m/Y"); ?> &nbsp;Hora: <?php echo date("g:i a"); ?>
            </strong>
        </div>
