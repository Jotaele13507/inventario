...
/* Función que trae el nombre de la categoria para la vista de productos
/*--------------------------------------------------------------*/
function join_product_table()
{
  global $db;
  $sql  = " SELECT p.id,p.name,p.partNo,p.quantity,p.buy_price,p.sale_price,p.location,p.media_id,p.date,c.code";
  $sql  .= " AS codigo,c.name AS categorie,m.file_name AS image";
  $sql  .= " FROM products p";
